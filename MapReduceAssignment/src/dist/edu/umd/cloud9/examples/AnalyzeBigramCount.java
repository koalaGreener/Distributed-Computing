...
/*		if (args.length != 1) {
		...
		try {
			...
			System.out.println("number of bigrams that appear only twice: " + singletons);
			...
			for (PairOfWritables<Text, IntWritable> bigram : bigrams) {
                ...
                cumulative_frequency += bigram.getRightElement().get();
				cnt++;
            ...
            percentage = 1.0 * cumulative_frequency / sum;
            System.out.println("\nThe cumulative frequency is: " + percentage);
